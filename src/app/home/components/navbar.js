    ...
    return (
        <div className="navbar fixed bg-base-100 shadow-md shadow-base-300 px-20 z-50">
            ...
            <div className="flex-none">
                <span className=" text-xl">John Francis Quinzon</span>

                <ul className="menu menu-horizontal px-1"><div tabIndex={0} role="button" className="btn btn-ghost btn-circle avatar">
